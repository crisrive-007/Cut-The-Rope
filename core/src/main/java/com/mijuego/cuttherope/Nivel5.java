...
public class Nivel5 implements Screen {
    ...
    public Nivel5(Usuarios jugador) {
    ...
    public void show() {
        ...
        dulce = new Dulce(world, Math.round(SCREEN_WIDTH * 0.5f), Math.round(SCREEN_HEIGHT * 0.75f), 32, new Texture("dulce2.png"));

        sombrero1 = new Sombrero(world, new Vector2(SCREEN_WIDTH * 0.7f, SCREEN_HEIGHT * 0.2f), "negro", 180);
        sombrero2 = new Sombrero(world, new Vector2(SCREEN_WIDTH * 0.16f, SCREEN_HEIGHT * 0.3f), "azul", 60);
        sombrero3 = new Sombrero(world, new Vector2(SCREEN_WIDTH * 0.9f, SCREEN_HEIGHT * 0.8f), "negro", 0);
