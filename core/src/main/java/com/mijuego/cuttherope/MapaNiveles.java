    ...
    public void show() {
        ...
        level1Button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                ((Game) Gdx.app.getApplicationListener()).setScreen(new Nivel1());
            }
        });
        ...
        level4Button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                //((Game) Gdx.app.getApplicationListener()).setScreen(new Nivel4Screen());
            }
        });
        ...
        level5Button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                //((Game) Gdx.app.getApplicationListener()).setScreen(new Nivel5Screen());
            }
        });
